...
export const socialMediaDesignerConfig = [
        {
            name : "Portfolio",
            statuses : [
        ...
        },
        {
            ...
            scoreDetails : {
                ...
                Engagement : {
                    description : "Evaluates visual hooks and audience relevance.",
                    isEditable : true
                },
                Adaptability : {
                    description : "Checks flexibility across formats and platforms.",
                    isEditable : true
                },
                Branding : {
                    description : "Assesses consistency with brand look and voice.",
                    isEditable : true
                },
                Communication : {
