...
export const motionDesignerConfig = [
        {
            name : "Portfolio",
            statuses : [
        ...
        },
        {
            ...
            scoreDetails : {
                ...
                Animation : {
                    description : "Judges smoothness, expression, and motion principles.",
                    isEditable : true
                },
                Tooling : {
                    description : "Evaluates proficiency in tools like After Effects or Blender.",
                    isEditable : true
                },
                Communication : {
