...
export const videoEditorConfig = [
        {
            name : "Portfolio",
            statuses : [
        ...
        },
        {
            ...
            scoreDetails : {
                ...
                Editing : {
                    description : "Judges pacing, flow, and cut quality.",
                    isEditable : true
                },
                Timing : {
                    description : "Assesses syncing of visuals and audio rhythm.",
                    isEditable : true
                },
                Composition : {
                    description :  "Evaluates shot arrangement and framing choices.",
                    isEditable : true
                },
                Communication : {
