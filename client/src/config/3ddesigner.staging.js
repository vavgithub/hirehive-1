...
export const threeDDesignerConfig = [
        {
            name : "Portfolio",
            statuses : [
        ...
        },
        {
            ...
            scoreDetails : {
                ...
                Modelling : {
                    description : "Judges accuracy, detail, and creativity in modeling.",
                    isEditable : true
                },
                Rendering : {
                    description : "Assesses rendering quality, lighting, and texturing.",
                    isEditable : true
                },
                Creativity : {
                    description : "Evaluates originality in visual concepts and outputs.",
                    isEditable : true
                },
                Communication : {
