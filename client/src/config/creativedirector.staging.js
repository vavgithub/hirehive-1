...
export const creativeDirectorConfig = [
        {
            name : "Portfolio",
            statuses : [
        ...
        },
        {
            ...
            scoreDetails : {
                ...
                Vision : {
                    description : "Assesses ability to set a compelling and strategic creative direction.",
                    isEditable : true
                },
                Leadership : {
                    description : "Evaluates ability to mentor, lead, and inspire creative teams.",
                    isEditable : true
                },
                Strategy : {
                    description : "Judges thinking aligned with brand and business goals.",
                    isEditable : true
                },
                Communication : {
