                    ...
                    <div className='flex flex-col gap-4 mt-6'>
                        ...
                        >
                            <div>
                                ...
                                <p className='text-font-gray typography-body mt-2 '>{assessment?.assessment_id?.title} - {assessment?.assessment_id?.category}</p>
                            </div>
                            <Button
                                onClick={() => handleStartAssessment(assessment?.assessment_id?._id)}
                                disabled={!isMediaRecorderOk || !isConsentChecked}
                            >
                                Start Assessment
                            </Button>
                        </StyledCard>))}
