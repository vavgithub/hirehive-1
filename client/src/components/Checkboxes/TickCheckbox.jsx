        ...
        <div className={`flex items-center gap-2 ${className} ${(checked && label) ? 'selection-primary' : ''}`}>
            <div className="relative  flex items-center justify-center">
                <input
                    ...
                    checked={checked}
                    onChange={onChange}
                    className="appearance-none  border mr-2 h-4 w-4 cursor-pointer rounded bg-background-100 hover:border-grey-100  checked:bg-accent-100 checked:border-accent-100 peer"
                />
