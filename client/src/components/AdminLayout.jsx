...
import { Briefcase, ChevronDown, ChevronUp, ClipboardCheck, FileText, IdCard, LayoutGrid, LogOut, MonitorDot, Settings, Star, User, UserCheck, Users } from 'lucide-react';
    ...
    const renderMenuItems = () => {
        ...
        return(
            <>
                ...
                {hasRoutePermission(user?.role,ROUTE_KEY.INTERVIEWS) && <NavItem to={getRoute(user.role,ROUTE_KEY.INTERVIEWS)} icon={() => <IconWrapper isInActiveIcon icon={MonitorDot} />} activeIcon={() => <IconWrapper isActiveIcon icon={MonitorDot} />}>Interviews</NavItem>}
