...
//       newFilteredRows = newFilteredRows.filter(row => filters.stage.includes(row.status));
//     }
//     if (filters.status.length > 0) {
//       newFilteredRows = newFilteredRows.filter(row => filters.status.includes(row.stage));
//     }
