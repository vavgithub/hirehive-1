...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleModal}
        className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-xl bg-background-70 hover:bg-accent-300 text-white shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-105"
