...
function ContactUsForm({isOpen,setIsOpen}) {
    ...
    return (
      <form onSubmit={handleFormSubmit(onSubmit)} className="space-y-4 mt-4 max-h-[50vh] overflow-y-scroll scrollbar-hide">
        ...
        <div className="mt-6">
          ...
          <div
            {...getRootProps({
              className: `bg-background-80 hover-outline hover:-outline-offset-2  rounded-xl mt-4 p-4 text-center cursor-pointer 
