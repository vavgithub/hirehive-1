...
const StatCard = ({ title, value, icon: Icon, statistics }) => {
  ...
  return (
    <StyledCard padding={2} backgroundColor={"bg-background-80"} extraStyles="flex  overflow-hidden justify-between relative items-center shadow min-w-[15rem] max-w-[15rem]">
      <div className=" w-full ">
        <p className="typography-small-p text-font-gray w-max mb-2">{title}</p>
        <h2 className="typography-h2 pb-2">{value ?? 0}</h2>
