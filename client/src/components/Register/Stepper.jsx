...
function Stepper({padding,steps,currentStep}) {
                ...
                steps?.map((stepObj,index,stepsArr)=>{
                    return (
                        ...
                        <div className='flex flex-col justify-center items-center gap-2 z-20 mx-4'>
                            <div className={'border-2  rounded-full aspect-square w-9 flex justify-center items-center p-1 ' + (((currentStep === stepObj.id) || (index < currentIndex)) ? "border-teal-100 text-teal-100" : "border-font-gray text-font-gray")}>
                                <p>{index + 1}</p>
                            </div>
