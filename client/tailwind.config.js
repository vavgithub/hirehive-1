...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        h1: ["2.25rem", { lineHeight: "1.25" ,letterSpacing : "1px"}],
        h2: ["2rem", { lineHeight: "1"  ,letterSpacing : "1px"}],
        h3: ["1.75rem", { lineHeight: "1.25" ,letterSpacing : "1px"}],
        h4: ["1.5rem", { lineHeight: "1.5" ,letterSpacing : "1px"}],
        h5: ["1.25rem", { lineHeight: "1.5" ,letterSpacing : "1px"}],
        h6: ["1rem", { lineHeight: "1.5" ,letterSpacing : "1px"}],
        ...
        "large-p": ["0.875rem", { lineHeight: "1.5" }],
      },
      fontWeight: {
        h1: "700",
        h2: "600",
